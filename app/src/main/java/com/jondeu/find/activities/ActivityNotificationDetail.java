...
import static com.jondeu.find.utilities.Constant.GET_PRODUCT_ID;
...
public class ActivityNotificationDetail extends AppCompatActivity {
    ...
    public void displayData() {
        ...
        if (Config.ENABLE_DECIMAL_ROUNDING) {
            ...
            txt_product_price.setText("от" + price + " " + currency_code);
        } else {
            txt_product_price.setText("от" + product_price + " " + currency_code);
        }
